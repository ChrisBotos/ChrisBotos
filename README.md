Computational biology researcher. I build mechanistic and inference models of RNA
Pol II transcription, and apply deep learning to multi-omics imaging.

**Now: IMBB-FORTH, MSc Bioinformatics & Systems Biology (UvA/VU).** Research
assistant under Matthieu Lavigne, building a four-part transcription-kinetics
framework:
...
- **KINEMA**: closed-form (non-simulated) stationary-probability solutions for
  ...
  motivated "cascade" transitions for packed-polymerase trains. Co-authored with
...
**From September 2026: MSc placement, Netherlands Cancer Institute** (van
Steensel group, Division of Gene Regulation). Extending PARM, a deep-learning
promoter-activity CNN published in Nature (doi: 10.1038/s41586-025-10093-z), to
endogenous transcription in K562, benchmarked against Activity-by-Contact. Daily
supervision by Oscar Garcia Blay, co-supervised by Vinicius Franceschini-Santos.

**Before: LUMC, spatial multi-omics** (Ahmed Mahfouz's group, Human Genetics).
Cell segmentation and vision transformers on tissue imaging:
